package com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest;

import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.model.aggregates.Profile;
import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.model.commands.CreateProfileCommand;
import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.model.queries.GetAllProfilesQuery;
import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.model.queries.GetProfileByIdQuery;
import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.model.queries.GetProfileByUsernameQuery;
import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.services.ProfileCommandService;
import com.dynoware.cargosafe.paymentcardsservice.profiles.domain.services.ProfileQueryService;
import com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest.resources.CreateProfileResource;
import com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest.resources.ProfileResource;
import com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest.resources.UpdateProfileResource;
import com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest.transform.CreateProfileCommandFromResourceAssembler;
import com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest.transform.ProfileResourceFromEntityAssembler;
import com.dynoware.cargosafe.paymentcardsservice.profiles.interfaces.rest.transform.UpdateProfileCommandFromResourceAssembler;
